...
include('backend/function-mahasiswa.php');
?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 fw-bold">Mahasiswa</h1>
                    <p class="mb-4">Dibawah ini adalah Tabel Data Mahasiswa</p>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered align-middle " style="font-size:14px" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        $ambil_data = mysqli_query($conn, "SELECT * FROM tb_mahasiswa ORDER BY nama_mahasiswa");
                                        $nomor = 1;
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <!-- <td><?= $alamat; ?></td> -->
                                                <td class="d-flex ">
                                                    <a class="btn btn-info action" style="font-size:12px" data-bs-toggle="modal" data-bs-target="#readData<?= $nim; ?>"><i class="fa-solid fa-eye"></i></a>
                                                    <a class="btn btn-success action mx-1" style="font-size:12px" data-bs-toggle="modal" data-bs-target="#editData<?= $nim; ?>"><i class="fa-solid fa-pen"></i></a>
                                                    <a class="btn btn-danger action " style="font-size:12px" data-bs-toggle="modal" data-bs-target="#hapusData<?= $nim; ?>"><i class="fa-solid fa-trash"></i></a>
                                                </td>
                                            </tr>

                                            <!-- Read Data Modal -->
                                            <div class="modal fade" id="readData<?= $nim; ?>">
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content p-3">
                                                        <div class="modal-header py-2">
                                                            <h4 class="modal-title fw-bold">Detail Data Mahasiswa</h4>
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="" method="POST">
                                                                <div class="row mb-3">
                                                                    <label for="nidn" class="col-sm-3 col-form-label">NIM</label>
                                                                    <div class="col-sm-9">
                                                                        <input type="text" disabled name="nim" value="<?= $nim; ?>" class="form-control bg-secondary-subtle" id="nim">
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
                                                                    <label for="nama_mahasiswa" class="col-sm-3 col-form-label">Nama Mahasiswa</label>
                                                                    <div class="col-sm-9">
                                                                        <input type="text" disabled name="nama_mahasiswa" value="<?= $nama_mahasiswa; ?>" class="form-control bg-secondary-subtle" id="nama_mahasiswa">
                                                                    </div>
                                                                </div>
                                                                <div class="row mb-3">
                                                                    <label for="jenis_kelamin" class="col-sm-3 col-form-label">Jenis Kelamin</label>
                                                                    <div class="col-sm-9">
                                                                        <select class="form-control bg-secondary-subtle" disabled name="jenis_kelamin">
                                                                ...
                                                                <div class="row mb-3">
                                                                    ...
                                                                    <div class="col-sm-9">
                                                                        <textarea disabled name="alamat" class="form-control bg-secondary-subtle" id="alamat" cols="" rows="3"><?php echo $alamat; ?></textarea>
                                                                    </div>
                                                                </div>
                                                            </form>
                                                        </div>
                                            ...
                                            <div class="modal fade" id="editData<?= $nim; ?>">
                                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                                    <div class="modal-content p-3">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="" method="POST">
                                                                <input type="hidden" name="nim" value="<?= $nim; ?>" class="form-control bg-secondary-subtle" id="nim">
                                                                <div class="row mb-3">
                                                                    <label for="nama_mahasiswa" class="col-sm-3 col-form-label">Nama Mahasiswa</label>
                                                                    <div class="col-sm-9">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered modal-md">
                                                    <div class="modal-content p-3">
                                                        ...
                                                        <div class="modal-body">
                                                            <form action="" method="POST">
                                                                <div class="my-2">
                                                                    <input type="hidden" value="<?= $nim; ?>" name="nim" id="nim">
                                                                    <h5>Apakah Kamu yakin akan menghapus data ini ?</h5>
                                                                </div>
                                                                <div class="modal-footer d-flex justify-content-center">
                                                                    <input type="submit" class="btn btn-primary" name="hapusDataMahasiswa" value="Hapus Data">
                                                                </div>
                                                            </form>
                                                        </div>
                                                    </div>
